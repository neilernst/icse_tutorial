...
```{r}
setwd("~/Documents/teaching/SENG404/src/icse_tutorial/") # or what your path is
...
The diagnostics (on the MC sampling) looks OK. $\widehat{R} < 1.01$ and the effective sample size (`ess_bulk`) is in the thousands, so all is well there. Let's also have a look at the trankplots for our estimated parameters.
